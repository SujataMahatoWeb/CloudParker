...
<div class="min-h-screen bg-gray-100 p-6">
    <h1 class="text-3xl font-bold text-red-600 text-center mb-6">
        Car or Bike Loan EMI Calculator
    </h1>
        ...
        <div class="max-w-6xl bg-white p-6 rounded-xl shadow-lg w-full">
            <div>
                <div>
                    ...
                    <input type="range" bind:value={loanAmount} min="10000" max="50000000" class="w-full">
                    <input type="number" bind:value={loanAmount} min="10000" max="50000000" step="" class="p-3 border rounded-lg my-4 lg:w-80 w-full" />
                    <p></p>

                    <label class="block font-semibold w-full">Annual Interest Rate(%)</label>
                    <input type="range" bind:value={annualInterest} min="1" max="10" step="1.1" class="w-full">
                    <input type="number" bind:value={annualInterest} min="1" max="10" step="1.1" class="p-3 border rounded-lg my-4 lg:w-80 w-full" />

                    <label class="block font-semibold w-full">Loan Tenure (years)</label>
                    ...
                    <label class="block font-semibold w-full">Loan Start Date</label>
            ...
            <div class="mt-6 space-y-2 p-4 lg:ml-176">
                ...
                <p class="mt-6 space-y-2 p-4 lg:ml-176">
                    Total Interest Paid: ₹ <span class="text-gray-500 text-2xl px-5 text-right inline-block">{formatINR(totalInterest)}</span>
                </p>
                <p class="mt-6 space-y-2 p-4 lg:ml-176">
